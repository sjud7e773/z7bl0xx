          ...
          <div className="max-w-[1440px] w-full mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10 py-12 md:py-24">
            ...
            <div className="flex flex-col gap-6 md:gap-8 max-w-[580px]">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
                ...
                <Link href="/como-funciona" className="w-full sm:w-auto bg-transparent border border-white text-white hover:bg-white/10 font-inter font-bold text-[15px] px-8 py-4 rounded-full text-center transition-all hover:scale-[1.02] active:scale-[0.98]">
        ...
        <section id="produtos" className="w-full px-6 py-12 md:py-24 bg-background flex flex-col gap-24">
          ...
          <div className="max-w-[1440px] mx-auto w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <Link href="/categoria/facas" className="font-inter font-bold text-accent-pink text-[14px] hover:text-white transition-colors">Ver Tudo &rarr;</Link>
